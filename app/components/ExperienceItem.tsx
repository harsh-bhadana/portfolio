        ...
        >
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-12">
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        <h3 className="text-xl md:text-3xl font-black text-foreground mb-2 leading-tight md:leading-none">{title}</h3>
                        <p className="text-accent text-base md:text-lg font-bold italic tracking-tight">{company}</p>
                    </div>
                </div>
                <div className="px-4 py-2 rounded-full bg-foreground/5 border border-foreground/10 text-[10px] font-black uppercase tracking-widest text-foreground/60 mt-6 md:mt-0">
                    {period}
                </div>
            </div>
                        ...
                        <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {project.highlights.map((highlight, hIndex) => (
                                <motion.li 
                                    ...
                                    className="flex items-start gap-4 p-4 rounded-2xl bg-foreground/[0.02] border border-foreground/5 group/li hover:border-accent/20 transition-all cursor-default"
                                >
